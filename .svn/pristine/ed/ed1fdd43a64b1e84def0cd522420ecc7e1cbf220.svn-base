...
<div id="content">
	...
	<th style="width:30%;">最后消费时间</th> 	 
	<th style="width:10%;">操作</th> 	 
	</tr>
	<c:forEach items="${cardslist}" var="p">
	<tr>
	<th style="width:25%;" class="border_right tablethcss">${p.card_no }</th> 	 
	<th style="width:10%;" class="border_right tablethcss">${p.userinfo.nick_name}</th> 	 
	<th style="width:15%;" class="border_right tablethcss">${p.userinfo.real_name}</th> 	 
	...
	<th style="width:30%;" class="border_right tablethcss"><fmt:formatDate value="${p.last_time }" pattern="yyyy-MM-dd HH:mm:ss"/> </th> 	 
	<th style="width:10%; min-width: 80px;" class="tablethcss">
		<div class="table_editor_button" onclick="editorcard(${p.id})" style="margin-left:2%; width: 59px; ">
			...
			<div class="table_button_text" style="color: #6097fb;">充值</div>
		</div>
	</th> 	 
	</tr>
	</c:forEach>
