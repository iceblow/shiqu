		...
		<div class="container-fluid" style="margin-top: 10px;">
			...
			<div class="row-fluid">
				...
				<div class="span10">
					<div class="row-fluid">
						<div class="span12">
							<button class="btn btn-primary" type="button" style="float: right;" data-toggle="modal" data-target="#myModal">添加拒绝理由</button>
						</div>
					</div>
					...
					<table class="table table-bordered table-hover" style="margin-top: 10px;">
						...
						<tbody>
							<c:forEach items="${refuselist}" var="c">
								<tr>
									<td>${c.content}</td>
									<td><button class="btn btn-small btn-info" type="button" onclick="edit(${c.id})" style="float: left;">编辑</button>
										<form action="./delrefuse" method="post" style="float: left; margin-left: 5px;margin-bottom:0px;">
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="row-fluid">
					<form action="./editrefuse" method="post" enctype="multipart/form-data">
						<div class="span10">
							<fieldset style="margin: 15px;">
								<div style="line-height: 40px; margin-left: 10px;">
									拒绝理由：&nbsp;
									<input type="text" id="alert_name" name="content" value="" style="width: 240px; margin-top: 5px;" />
								</div>
								<input type="hidden" id="hidden_cid" name="id" value="0" />
							</fieldset>
						</div>
						<div class="span2">
