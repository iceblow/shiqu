...
$(document).keydown(
		function(event) {
			if (event.keyCode == 13) { 
				...
				var display = $("#box_detail").css("display");
				if(display=='block'){
					searchWord();
				}
				} 
...
<div style="height: 100%; line-height: 75px; float:left; margin-left: 20px;">
		<input type="text" class="form-control" name="min_send" id="min_send" value="${store.min_send }" onkeyup="checkKeyForFloat(event, 'min_send')" required="required" style="width: 400px; height: 33px; padding-left:5px; margin-top: 20px;">
</div>
</div>
...
<div style="height: 100%; line-height: 75px; float:left; margin-left: 20px;">
		<input type="text" class="form-control" onkeyup="checkKeyForFloat(event, 'send_money')" name="send_money" id="send_money" value="${store.send_money }" required="required" style="width: 400px; height: 33px; padding-left:5px; margin-top: 20px;">
</div>
</div>
...
<div style="height: 100%; line-height: 75px; float:left; margin-left: 20px;">
		<input type="text" class="form-control" name="send_time" id="send_time" onkeyup="return checkNum(event,'send_time')" onkeyup= "return checkNum(event,'send_time')" value="${store.send_time }" required="required" style="width: 400px; height: 33px; padding-left:5px; margin-top: 20px;">
</div>
</div>
...
<div style="height: 100%; line-height: 75px; float:left; margin-left: 20px;">
	<textarea class="form-control intro" name="intro" style="height:76px;resize: none;margin-top:20px;width:605px;" maxlength="250" onpropertychange="onmyinput(this)" oninput="return onmyinput(this)" onPaste="return onmypaste(this);" onKeyPress="return onmykeypress(this);" >${store.intro }</textarea>
</div>
</div>
...
<div style="height: 100%; line-height: 75px; float:left; margin-left: 20px;">
	...
	<input type="hidden" value="${store.longitude }" id="longitude" name="longitude">
		<input type="text" class="form-control" name="address" id="address" value="${store.address }" required="required" maxlength=20 style="width: 600px; height: 33px; padding-left:5px; margin-top: 20px;">
...
<div id="box_detail" class="alert" style="display: none;">
	...
	<div style="margin-top:15px;height:30px;">
		<input type="text" class="form-control"  id="alertaddress" value="${store.address }" style="float:left;width: 550px; height: 30px;margin-left:10px; padding-left:5px; ">
	...
	<div style="position: relative;margin-top:15px;">
		<div id="l-map" class="l-map" style="width:750px;border: 1px solid #e8e8e8;margin: 10px;"></div>
		<div id="r-result"></div>
	</div>
</div>
	    ...
	    if (local.getStatus() == BMAP_STATUS_SUCCESS){
	        if(results.getCurrentNumPois() == undefined){
	    	   ...
	    	   var lat2 = results.getPoi(0).point.lat;
		    	...
		    	var label = new BMap.Label($("#alertaddress").val(),{offset:new BMap.Size(20,-10)});
		    	label.setStyle({
		    		borderColor:"#000000",
		    	 });
				 var marker = new BMap.Marker(point0);
		 		 ...
		 		 $("#alertlongitude").val(lon2);
			   	 $("#alertlatitude").val(lat2);
	    }else{
