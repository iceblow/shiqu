...
<body>
<form action="./addoutaddress" method="post" id="delivery">
...
<div class="addressdetail">
	...
	<div class="address_detail_right"><input class="address_detail_right_input"  placeholder="请输入" name="phone" id="phone"></div>
</div>
<div class="addressdetail">
