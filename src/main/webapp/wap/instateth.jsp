...
<div class="order_detail_center" id="cancelprice" style="border: 0px;">
	<div style="float:right;">金额：<font style="color: #ff4532">${order.total_price }元</font> </div>
</div>
...
<div style="width: 100%; height: 50px; background: #f0f0f0;">
	<div style="width: 92%; height: 50px; line-height: 50px;  margin: 0 auto;">拒单理由：${order.refuse_reason }</div>
</div>
</body>
</html>