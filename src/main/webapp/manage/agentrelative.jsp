							...
							<c:if test="${pageCount>1}">
                                ...
                                var a = [];
                                  ...
                                  if (pageindex == 1) {
                                    ...
                                    a[a.length] = "<li><a onclick=\"previousPage("+pageindex+",'./relativeAgentStoreList?')\" class=\"page_prev\">&laquo;</a></li>";
                                  }
                                  function setPageList() {
                                    if (pageindex == i) {
                                      a[a.length] = "<li class='active'><a onclick=\"goPage('./relativeAgentStoreList?',"+i+")\" class=\"on\">" + i + "</a></li>";
                                    } else {
                                      a[a.length] = "<li><a onclick=\"goPage('./relativeAgentStoreList?',"+i+")\">" + i + "</a></li>";
                                    }
                                  }
                                  //总页数小于10
                                  if (count <= 10) {
                                    ...
                                    if (pageindex <= 4) {
                                      ...
                                      a[a.length] = "...<li><a onclick=\"goPage('./relativeAgentStoreList?',"+count+")\">" + count + "</a></li>";
                                    } else if (pageindex >= count - 3) {
                                      a[a.length] = "<li><a onclick=\"goPage('./relativeAgentStoreList?',1)\">1</a></li>...";
                                  ...
                                  if (pageindex == count) {
                                        ...
                                        "<li><a style='border-left-width: 1px; border-radius: 4px;' class=\"jump_btn\" onclick=\"gotoPage('./relativeAgentStoreList?',"+$("#pageSize").val()+")\")\">确定</li>";
                                      } else {
                                        a[a.length] = 
                                            "<li><a style='border-bottom-right-radius:4px;border-top-right-radius:4px; ' onclick=\"nextPage("+$("#pageIndex").val()+",'./relativeAgentStoreList?')\" "+
