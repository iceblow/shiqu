...
<body>
	...
	<div style="width: 100%; height: 75px; border-bottom: 1px solid #eaeff2;">
	<div style="font-size:12px;font-weight:bold;float:left; width: 110px; height: 100%; line-height: 75px;padding-right:30px; border-right: 1px solid #eaeff2;text-align: right;">打印宽度</div>
	<div style="height: 100%; line-height: 75px; float:left; margin-left: 20px;">
	...
	<div style="width: 100%; height: 75px; border-bottom: 1px solid #eaeff2;">
	<div style="font-size:12px;font-weight:bold;float:left; width: 110px; height: 100%; line-height: 75px;padding-right:30px; border-right: 1px solid #eaeff2;text-align: right;">打印格式</div>
	<div style="height: 100%; line-height: 75px; float:left; margin-left: 20px;">
			...
			<option value="4" >送厨总单</option>
			<option value="5" >送厨分单</option>
			</c:if>
			<c:if test="${print.scope== 2  }">
			<option value="1" >通用</option>
			<option value="2" selected="selected">预结单</option>
			<option value="3" >收银</option>
			<option value="4" >送厨总单</option>
			<option value="5" >送厨分单</option>
			</c:if>
			...
			<option value="1" >通用</option>
			<option value="2" >预结单</option>
			<option value="3" selected="selected">收银</option>
			<option value="4" >送厨总单</option>
			<option value="5" >送厨分单</option>
			</c:if>
			<c:if test="${print.scope== 4  }">
			<option value="1" >通用</option>
			<option value="2" >预结单</option>
			<option value="3" >收银</option>
			<option value="4" selected="selected">送厨总单</option>
			<option value="5" >送厨分单</option>
			</c:if>
			
			<c:if test="${print.scope== 5  }">
			<option value="1" >通用</option>
			<option value="2" >预结单</option>
			<option value="3" >收银</option>
			<option value="4" >送厨总单</option>
			<option value="5" selected="selected">送厨分单</option>
			</c:if>
